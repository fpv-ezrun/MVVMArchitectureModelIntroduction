    ...
    private fun updateText(){
        ...
        findViewById<Button>(R.id.buttonChercher).setOnClickListener {
            ...
            if(viewModel.numberSaisie % 2 == 0){
                //findViewById<TextView>(R.id.multiple2).text = "MULTIPLE DE 2: OUI"}else { //par de persistance en cas de rotation (cf livedata)
                //findViewById<TextView>(R.id.multiple2).text = "MULTIPLE DE 2: NON"
